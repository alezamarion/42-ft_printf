...
/*   Updated: 2021/08/01 17:38:56 by azamario         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
void	print_id_positive(t_flags fl, int number, int *len)    		// (" %.2d ", -1)  (" %.2d ", 1)
{
	int size;
...
*/
/*
void	print_id_negative(t_flags fl, int number, int *len)    		// (" %.2d ", -1)  (" %.2d ", 1)
{
	int size;
